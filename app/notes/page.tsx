          ...
          <div className="text-center py-20">
            <div className="relative mx-auto w-fit">
              ...
              <div className="relative w-20 h-20">
                ...
                {/* Inner ring */}
                <div className="absolute top-2 left-2 w-16 h-16 rounded-full border-4 border-transparent border-r-blue-400 animate-spin" style={{ animationDirection: 'reverse', animationDuration: '0.8s' }}></div>
              ...
              <div className="mt-8 space-y-3">
                <h3 className="text-xl font-semibold text-gray-900">Loading Your Notes</h3>
                <p className="text-gray-600">Fetching your content from the cloud...</p>
              </div>
              ...
              <div className="flex justify-center space-x-2 mt-6">
                ...
                <div className="w-2 h-2 bg-blue-300 rounded-full animate-bounce" style={{ animationDelay: '450ms' }}></div>
              </div>
              
              {/* Subtle background animation */}
              <div className="absolute -inset-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-full opacity-20 animate-pulse"></div>
            </div>
          </div>
